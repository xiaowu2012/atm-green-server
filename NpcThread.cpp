...
//			if(pNpc->m_tNpcType == NPCTYPE_GUILD_MARK && !pNpc->m_bFirstLive) continue;
			...
			case NPC_DEAD:
				//if(pNpc->m_sCurZ == 34)//든1寧땍珂쇌岬밍 MarkJay
				//{
				//	SYSTEMTIME st;
				//	GetLocalTime(&st);
				//	if(st.wHour == 6 && st.wMinute == 0 && st.wSecond == 25)
				//	{
				//		if(pNpc->m_sSid == 129 || pNpc->m_sSid == 130 || pNpc->m_sSid == 131 || pNpc->m_sSid == 132 || pNpc->m_sSid == 133 || pNpc->m_sSid == 134 || pNpc->m_sSid == 135)
				//		{
				//			pNpc->NpcTrace(_T("NpcDead"));
				//			pNpc->m_NpcState = NPC_LIVE;
				//		}
				//	}
				//	else if(st.wHour == 12 && st.wMinute == 0 && st.wSecond == 25)
				//	{
				//		if(pNpc->m_sSid == 129 || pNpc->m_sSid == 130 || pNpc->m_sSid == 131 || pNpc->m_sSid == 132 || pNpc->m_sSid == 133 || pNpc->m_sSid == 134 || pNpc->m_sSid == 135)
				//		{
				//			pNpc->NpcTrace(_T("NpcDead"));
				...
				//		}
				//	}
				//	else if(st.wHour == 18 && st.wMinute == 0 && st.wSecond == 25)
				//	{
				//		if(pNpc->m_sSid == 129 || pNpc->m_sSid == 130 || pNpc->m_sSid == 131 || pNpc->m_sSid == 132 || pNpc->m_sSid == 133 || pNpc->m_sSid == 134 || pNpc->m_sSid == 135)
				//		{
				//			pNpc->NpcTrace(_T("NpcDead"));
				...
				//		}
				//	}
				//	else if(st.wHour == 23 && st.wMinute == 0 && st.wSecond == 25)
				//	{
				//		if(pNpc->m_sSid == 129 || pNpc->m_sSid == 130 || pNpc->m_sSid == 131 || pNpc->m_sSid == 132 || pNpc->m_sSid == 133 || pNpc->m_sSid == 134 || pNpc->m_sSid == 135)
				//		{
				//			pNpc->NpcTrace(_T("NpcDead"));
